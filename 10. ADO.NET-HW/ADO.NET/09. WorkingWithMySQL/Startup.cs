namespace WorkingWithMySQL
{
    ...
    public class Startup
    {
        ...
        private static MySqlConnection mySqlConnection = new MySqlConnection("Server=localhost; Database=library; Uid=root; Pwd=Your pass;");
        ...
        {
            mySqlConnection = new MySqlConnection("Server=localhost; Database=library; Uid=root; Pwd=Your pass;");
